...
variable "redrive_policy_count" {
  description = "COUNT FOR The JSON policy to set up the Dead Letter Queue. Note - when specifying maxReceiveCount you must specify it as an integer and not a string."
  default     = 1
}
